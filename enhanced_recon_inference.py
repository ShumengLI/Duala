...
all_images = torch.load(f"/data/lsm/hub/datasets--pscotti--mindeyev2/snapshots/26421f100e4c6012a35ecadb272a0ec1d999202d/evals/all_images.pt")
all_recons = torch.load(f"{eval_dir}/{model_name}/{model_name}_all_recons.pt") # these are the unrefined MindEye2 recons!
all_clipvoxels = torch.load(f"{eval_dir}/{model_name}/{model_name}_all_clipvoxels.pt")
all_blurryrecons = torch.load(f"{eval_dir}/{model_name}/{model_name}_all_blurryrecons.pt")
all_predcaptions = torch.load(f"{eval_dir}/{model_name}/{model_name}_all_predcaptions.pt")
...
base_ckpt_path = '/data/lsm/hub/datasets--pscotti--mindeyev2/snapshots/26421f100e4c6012a35ecadb272a0ec1d999202d/zavychromaxl_v30.safetensors'
...
torch.save(all_enhancedrecons,f"{eval_dir}/{model_name}/{model_name}_all_enhancedrecons.pt")
